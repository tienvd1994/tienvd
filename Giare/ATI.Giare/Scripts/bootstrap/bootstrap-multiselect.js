...
!function($) {"use strict";// jshint ;_;
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            // If more than 4 options are selected, the number of selected options is printed.
        ...
        buildFilter: function() {
            $('.multiselect-container', this.$container).prepend('<div class="input-group"><span class="input-group-addon"><i class="icon-search"></i></span><input class="form-control multiselect-search" type="text" placeholder="' + this.options.filterPlaceholder + '"></div>');
