...
function CateNewView() {
    ...
    self.Search = function (currentPage) {
        ...
        $.get("/cms/SearchCateNews", { langId: self.LangId(), type: 1, key: self.Keyword(), pageIndex: CurrentPage, recordPerPage: RecordPerPage }, function (data) {
            if (data === -1) {
    ...
    self.Update = function () {
        ...
        if (self.IsAdd()) {
            $.post('/CMS/AddCateNews', { Name: self.Name(), EnglishName: self.Name(), OrderNo: self.OrderNo(), LangId: self.LangId(), Type: 1 }, function (data) {
            ...
            $.post('/CMS/UpdateCateNews', { ID: self.ID(), Name: self.Name(), EnglishName: self.Name(), OrderNo: self.OrderNo(), LangId: self.LangId(), Type: 1 },
                function (data) {
